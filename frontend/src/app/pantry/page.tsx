...
export default function PantryScannerPage() {
  ...
  const handleScan = async () => {
    ...
    try {
      ...
      console.error(err);
      alert(
        "Failed to scan image. Make sure the backend is running and the image is valid.",
      );
    } finally {
      setLoading(false);
    }
    ...
    >
      ...
      <div style={{ padding: 20 }}>
        ...
        >
          ...
          <h2 style={{ margin: "0 0 10px", color: "#0F1111" }}>
            What are you missing?
          </h2>
          <p style={{ color: "#555", fontSize: 14, marginBottom: 20 }}>
            Upload a photo of your fridge or pantry. Our AI will instantly
            detect what's low and build a cart for you.
          </p>
        ...
        {results.length > 0 && (
          <div style={{ marginTop: 20 }}>
            <h3 style={{ fontSize: 16, color: "#0F1111", marginBottom: 10 }}>
              Added to your cart
            </h3>
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {results.map((item, i) => (
                ...
                >
                  ...
                  <img
                    src={
                      item.image_url || "https://placehold.co/100x100?text=Item"
                    }
                    alt={item.name}
                  ...
                  <p style={{ margin: 0, fontWeight: 700, color: "#B12704" }}>
