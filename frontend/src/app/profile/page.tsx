...
const DIET_OPTIONS = ['vegan', 'vegetarian', 'keto', 'halal', 'pescatarian', 'gluten-free'];
const ALLERGEN_OPTIONS = ['nuts', 'gluten', 'dairy', 'soy', 'shellfish', 'eggs'];
...
export default function ProfilePage() {
  ...
  return (
    <div style={{ background: '#F7F7F7', minHeight: '100vh', paddingBottom: 40 }}>
      {/* Header */}
      <div style={{
        background: 'white', padding: '16px 14px', borderBottom: '1px solid #E0E0E0',
        ...
        <h1 style={{ fontSize: 16, fontWeight: 700, color: '#0F1111', margin: 0 }}>
          Dietary &amp; Allergy Profile
        </h1>
      </div>

      {/* Dietary Preferences */}
      <section style={{ background: 'white', margin: '8px 0 0', padding: '16px 14px' }}>
        <h2 style={{ fontSize: 14, fontWeight: 700, color: '#0F1111', margin: '0 0 12px' }}>
          🥗 Dietary Preferences
        </h2>
