...
import { placeOrder, Order, fetchCoupons, CouponResult, deleteSharedCart } from '@/lib/api';
      ...
      <div className="min-h-screen bg-[#F0F2F2] flex items-center justify-center px-4">
        <div className="bg-white rounded-2xl p-8 w-full max-w-sm text-center shadow-xl">
          ...
          <div className="bg-blue-50 border border-blue-100 rounded-xl p-3 mb-4">
            ...
            <p className="text-xs text-blue-700 font-medium mt-1">Preparing your order</p>
          </div>
          {totalSavings > 0 && (
          ...
          <p className="text-sm text-gray-500 mb-6">
            Total paid: <span className="font-bold text-gray-900">₹{total.toFixed(2)}</span>
          </p>
