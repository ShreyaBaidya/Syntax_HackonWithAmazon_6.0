  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{ fontSize: 26, fontWeight: 400, color: '#0F1111', margin: '0 0 6px' }}>
          Sign in
        </h1>
          ...
          {DEMO_USERS.map(user => {
            ...
            return (
              <button
                ...
                onMouseEnter={e => {
                  if (!loadingEmail) (e.currentTarget as HTMLButtonElement).style.borderColor = '#E77600';
                }}
                onMouseLeave={e => {
                  if (!loadingEmail) (e.currentTarget as HTMLButtonElement).style.borderColor = '#D5D9D9';
                }}
              >
                {/* Avatar */}
                ...
                <img
                  ...
                  width={44}
                  height={44}
                  style={{ borderRadius: '50%', flexShrink: 0, background: '#F5F5F5' }}
                />

                {/* Name + subtitle */}
                <div style={{ flex: 1 }}>
                  <p style={{ margin: 0, fontSize: 15, fontWeight: 600, color: '#0F1111' }}>
                    {user.name}
                  </p>
                  <p style={{ margin: '2px 0 0', fontSize: 12, color: '#767676' }}>
                    {user.email}
                  </p>
                </div>
        ...
        {/* Fine print */}
        <p style={{ fontSize: 11, color: '#767676', margin: '22px 0 0', lineHeight: 1.6 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16, width: '100%', maxWidth: 380 }}>
        ...
        <svg width="80" height="20" viewBox="0 0 80 20" fill="none">
          <text x="0" y="15" fontSize="13" fontWeight="700" fill="#767676" fontFamily="Georgia, serif">amazon</text>
        </svg>
        <div style={{ flex: 1, height: 1, background: '#E0E0E0' }} />
      </div>
